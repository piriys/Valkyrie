module.exports = class OpenWeatherHelpers {
  static getCountryNameFromCountryCode(id) {
    const countries = {
      AF: 'Afghanistan',
      AX: 'Aland Islands',
      AL: 'Albania',
    ...
    return countries[id] ? countries[id] : 'Unknown Country';
  }
  static getWeatherSymbolFromId(id) {
    const symbols = {
    ...
    return symbols[id] ? symbols[id] : ':question:';
  }
};
